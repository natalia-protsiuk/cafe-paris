...
export const metadata: Metadata = {
  ...
  description: "Cafe Paris — ресторан у Миколаєві з банкетним залом до 100 гостей. Пропонуємо весільні меню від 1000 грн, банкети, авторську кухню та бронювання дат для свят.",
};
